...
export class MainPage implements OnInit {
    ...
    fillInAddress() {
        ...
        function initAutocomplete() {
            address1Field = document.querySelector("#vStreet") as HTMLInputElement;
            address2Field = document.querySelector("#vStreetnumber") as HTMLInputElement;
            postalField = document.querySelector("#vZip") as HTMLInputElement;
